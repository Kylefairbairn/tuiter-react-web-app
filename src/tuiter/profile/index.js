    ...
    <>
      <div className={"row"}>
        ...
        <div className={"col-11 text-secondary"}>
          ...
          <p className={"mb-1"}>{profile.tuitCount.toLocaleString()} Tuits</p>
        </div>
      </div>
      <div className="row">
        <img
      ...
      <div className={"row"}>
        <div className={"col-8 position-relative"}>
          <img
            className={
              "rounded-circle position-absolute border border-white wd-profile-icon m"
            }
