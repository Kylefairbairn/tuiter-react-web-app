  ...
  return (
    <>
      <div className={"row"}>
        <div className={"col-1"}>
          <Link to="/tuiter/profile">
            <i className={"bi bi-x fs-3 text-black"}></i>
          </Link>
        </div>
      ...
      <div className="row position-relative">
        <img
          className={" w-100 wd-profile-icon"}
          src={`/images/${profile.bannerPicture}`}
          alt=""
        />
        <div className={"position-relative"}>
          <img
            className={"position-absolute rounded-circle wd-profile-icon"}
            src={`/images/${profile.profilePicture}`}
            alt=""
          />
          <button
            className={
              "position-relative btn btn-dark rounded-circle wd-change-profile-icon "
            }
          >
      ...
      <form>
        <div className={"form-group pt-4"}>
          <div
            className={
              "border border-secondary rounded-2 border-opacity-25 p-1"
            }
          >
            <label
              className={"ps-2 text-secondary fs-6"}
              htmlFor={"name-field"}
            >
              Name
            </label>
        ...
        <div className={"form-group pt-3"}>
          ...
          >
            <label className={"ps-2 text-secondary fs-6"} htmlFor={"bio-field"}>
              Bio
            </label>
            <textarea
              className={"form-control border-0 ps-2"}
